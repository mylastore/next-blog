...
const updateProfile = () => {
  ...
  const {password, confirm, message, match, btnDisabled} = passwordValues
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      window.scrollTo(500, 0)
      return flash('User updated!', 'success')
    ...
    <form className="mt-4" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <small id="usernameHelp" className="form-text text-muted">
          Create a unique username. Username will display on you public profile and blogs posts.
        </small>
      </div>
      <div className="form-group">
